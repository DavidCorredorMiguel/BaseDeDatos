...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-04-2021 a las 12:19:24
...
--
-- Estructura de tabla para la tabla `butaca_letra`
--
...
--
-- Volcado de datos para la tabla `butaca_letra`
--
...
--
-- Estructura de tabla para la tabla `pase_sala`
--
...
--
-- Volcado de datos para la tabla `pase_sala`
--
...
--
-- Indices de la tabla `butaca_letra`
--
...
--
-- AUTO_INCREMENT de la tabla `pase_sala`
--
ALTER TABLE `pase_sala`
